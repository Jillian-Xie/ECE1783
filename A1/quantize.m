...
blockWidth = size(transformedCoefficientBlock,1);
blockHeight = size(transformedCoefficientBlock,2);

QMatrix(1:blockWidth, 1:blockHeight) = int32(0);
quantizedtransformedBlock(1:blockWidth, 1:blockHeight) = int32(0);
