...
paramCIF_1 = struct('yuvInputFileName', 'CIF.yuv','nFrame', 21,'width', 352,'height', 288,'blockSize', 16,'r', 16,'QPs', QPs,'QP', 4,'I_Period', 1,'nRefFrames', 1,'VBSEnable', true,'FMEEnable', true,'FastME', true,'visualizeVBS', false,'visualizeRGB', false,'visualizeMM', false,'visualizeNRF', false,'RCFlag', true,'targetBR', 2400000,'frameRate', 30);
paramCIF_4 = struct('yuvInputFileName', 'CIF.yuv','nFrame', 21,'width', 352,'height', 288,'blockSize', 16,'r', 16,'QPs', QPs,'QP', 4,'I_Period', 4,'nRefFrames', 1,'VBSEnable', true,'FMEEnable', true,'FastME', true,'visualizeVBS', false,'visualizeRGB', false,'visualizeMM', false,'visualizeNRF', false,'RCFlag', true,'targetBR', 2400000,'frameRate', 30);
paramCIF_21 = struct('yuvInputFileName', 'CIF.yuv','nFrame', 21,'width', 352,'height', 288,'blockSize', 16,'r', 16,'QPs', QPs,'I_Period', 21,'QP', 4,'nRefFrames', 1,'VBSEnable', true,'FMEEnable', true,'FastME', true,'visualizeVBS', false,'visualizeRGB', false,'visualizeMM', false,'visualizeNRF', false,'RCFlag', true,'targetBR', 2400000,'frameRate', 30);
paramQCIF_1 = struct('yuvInputFileName', 'QCIF.yuv','nFrame', 21,'width', 176,'height', 144,'blockSize', 16,'r', 16,'QPs', QPs,'I_Period', 1,'QP', 4,'nRefFrames', 1,'VBSEnable', true,'FMEEnable', true,'FastME', true,'visualizeVBS', false,'visualizeRGB', false,'visualizeMM', false,'visualizeNRF', false,'RCFlag', true,'targetBR', 960000,'frameRate', 30);
paramQCIF_4 = struct('yuvInputFileName', 'QCIF.yuv','nFrame', 21,'width', 176,'height', 144,'blockSize', 16,'r', 16,'QPs', QPs,'I_Period', 4,'QP', 4,'nRefFrames', 1,'VBSEnable', true,'FMEEnable', true,'FastME', true,'visualizeVBS', false,'visualizeRGB', false,'visualizeMM', false,'visualizeNRF', false,'RCFlag', true,'targetBR', 960000,'frameRate', 30);
paramQCIF_21 = struct('yuvInputFileName', 'QCIF.yuv','nFrame', 21,'width', 176,'height', 144,'blockSize', 16,'r', 16,'QPs', QPs,'I_Period', 21,'QP', 4,'nRefFrames', 1,'VBSEnable', true,'FMEEnable', true,'FastME', true,'visualizeVBS', false,'visualizeRGB', false,'visualizeMM', false,'visualizeNRF', false,'RCFlag', true,'targetBR', 960000,'frameRate', 30);
...
for i = 1:(nargin-4)
    ...
    decoder(varargin{i}.nFrame, varargin{i}.width, varargin{i}.height, ...
        varargin{i}.blockSize, varargin{i}.I_Period, varargin{i}.VBSEnable, ...
